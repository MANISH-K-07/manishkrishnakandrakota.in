...
[![CMU](https://img.shields.io/badge/🎓_CMU_MSIS-Fall_2026-c41230?style=for-the-badge&labelColor=050b18)](https://www.cmu.edu/)
...
│
├── assets/
│   ├── KrishProfile.jpg                          # Profile photo
│   ├── ManishKrishnaKandrakotaResume.pdf         # Downloadable resume
│   │
│   ├── ManishK_LOR_Dr_K_Shirisha.pdf             # LOR — HoD, CSE, SNIST
│   ├── ManishK_LOR_Ch_SrinathReddy.pdf           # LOR — Faculty, CSE, SNIST
│   └── ManishK_LOR_RomanIvanov.pdf               # LOR — Project Admin, Checkstyle
│
└── README.md
```
